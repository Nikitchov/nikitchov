...
<p align="left">
  Привет, меня зовут Никита Батяев. Я - frontend-разработчик, заинтересованный в поиске увлекательной работы в этой области. В своей работе я использую современные технологии, включая TypeScript, JavaScript, React и Redux, а также обладаю опытом работы с Vue.js и Next.js. 
