...
<p align="left">
  Привет, меня зовут Никита Батяев. Я - frontend-разработчик, заинтересованный в поиске увлекательной работы в этой области. Мой основной стек технологий включает в себя JavaScript, React, HTML, CSS и Next.js. Я также имею небольшой опыт работы с Vue.js. Для создания пользовательских интерфейсов я использую библиотеку React, а также имею опыт работы с Next.js для разработки веб-приложений.
